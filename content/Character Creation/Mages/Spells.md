...
**Augments**
*Amped. 2+ Mana*
Targets who fail their save take an additional 1d4 damage for every **2 Mana** spent.

*Extended. 1+ Mana*
For every **Mana** spent, increase the size of the Arc by 2.
...
**Augments**
*Blazing. 2+ Mana*
The damage dealt by the spell increases by 1 for every **2 Mana** spent.

*Extend. 1+ Mana*
Increase the size of the Arc by 2 for each **Mana** spent.
...
**Augments**
*Dense. 2 Mana*
The fog instead grants **hard cover**.

*Noxious. 2 Mana*
Reduce the size of the Circle by 1. When a character moves into the Circle or starts their turn there, they must make a **MIGHT** save or take 1 damage. Additionally, the spell gains the Poison tag.
...
**Augments**
*Colossal. 1+ Mana*
The boulder deals an additional 1d6 damage for every **1 Mana** spent.

*Dazing. 2 Mana*
If a character fails their save against the boulder, they are [[Conditions & Statuses#STUNNED|STUNNED]].
...
When you do so, make an attack against a character within Range 8. On a hit, the target takes 1d10 damage and is slowed. Regardless if you hit or miss, the spear shatters.
...
Each spear deals an additional 1d10 damage on a hit.
...
**Augments**
*Curved. 2 Mana*
You create an Arc instead of a Line, of the same size.
...
**Augments**
*Distant. 1+ Mana*
You extend the range of this spell by 2 for every **Mana** spent.

*Forced. 2 Mana*
You instead attempt to teleport an unwilling character within Reach 1. The target must make a **PRESENCE** save to resist the effect.
...
## Tier III
- Open a Gate to the Sun, shooting a sun laser in a line