...
Advanced Exploration provides a set of rules to allow for a slow-paced, in-depth travel across large distances within a campaign. If your campaign places a large focus on getting from one place to another (and you want the process of getting there to be a slow, but eventful process) then Advanced Exploration may be for you.

If you plan for your game to have any of the following, Advanced Exploration is not recommended:
- Your game will consist of one or a handful of sessions.
- Your game's story is mostly within one place, such as a city.
- The idea of setting out on a slow adventure that focuses on finding where you need to go does not sound enjoyable to you.
## Hexcrawl
Advanced Exploration is based upon a mechanic dubbed the "Hexcrawl". 

To build a hexcrawl, we must first have a map overlayed with a hexagonal grid. Each hexagon on this grid is called a **Hex**. For ***BOUNDLESS***, the distance from the centre of one Hex to another is about 5 kilometres (3 miles), or about the distance to your horizon.
...
### Adventuring Day
A typical day for adventuring can be broken down into the following:
- 8 hours of travel,
...
- Loot can be:
	...
	- Information about the hexcrawl (the players find a journal detailing a lost ruin just north of here)
	- Lore
### Landmarks
